...
$(OTD)main.o: $(A)main.c
	$(CC) $(CFLAGS) -I ctests -I src -c $(A)main.c -o $(OTD)main.o  -lm
$(OTD)perimetr.o: $(SD)perimetr.c $(SD)foo.h
	$(CC) $(CFLAGS) -I ctests -I src -c $(SD)perimetr.c -o $(OTD)perimetr.o  -lm
$(OTD)square.o: $(SD)square.c $(SD)foo.h
	$(CC) $(CFLAGS) -I ctests -I src -c $(SD)square.c -o $(OTD)square.o  -lm
$(OTD)cross.o: $(SD)cross.c $(SD)foo.h
	$(CC) $(CFLAGS) -I ctests -I src -c $(SD)cross.c -o $(OTD)cross.o  -lm
clean:
